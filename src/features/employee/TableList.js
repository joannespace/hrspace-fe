            ...
            .map((employee, index) => (
              ...
              >
                ...
                <TableCell
                  align="left"
                  sx={{
                    color: !employee.department ? "primary.darker" : "",
                  }}
                >
                ...
                <TableCell align="left">
                  <Chip
                    variant="outlined"
                    label={
                      employee.employmentType ? employee.employmentType : "N/A"
                    }
                ...
                <TableCell
                  ...
                  onClick={() => {
                    if (employee.paperwork.length > 0) {
                      navigate(`/employee/${employee._id}/paperwork`);
                    } else {
                ...
                >
                  {employee.paperwork.length > 0 ? (
                    employee.paperwork[0].paperworkType
                  ) : (
                    <Chip
