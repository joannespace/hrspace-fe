...
const maxBirthday = new Date(Date.now() - 1000 * 60 * 60 * 24 * 365 * 18);
...
export const EMPLOYEE_INFO_SCHEMA = yup.object({
  ...
  password: yup.string().max(20, "Password can not exceed 20 characters"),
  ...
  lineManager: yup.string("Invalid Line Manager"),
